...
public final class ActivityFullscreenTimelineBinding implements ViewBinding {
  ...
  private ActivityFullscreenTimelineBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull LinearLayout headerSection, @NonNull RecyclerView recyclerViewTimeline,
      @NonNull TextView textPatientInfo, @NonNull TextView textPatientName,
      @NonNull LinearLayout timelineHeader) {
  ...
  public static ActivityFullscreenTimelineBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFullscreenTimelineBinding((ConstraintLayout) rootView, buttonBack,
          fabAddEvent, headerDay, headerMonth, headerSection, recyclerViewTimeline, textPatientInfo,
          textPatientName, timelineHeader);
    }
